...
namespace PaymentProcessor.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<PaymentProcessorContext>(options =>options.UseSqlServer(Configuration.GetConnectionString("PaymentProcessorContext")));

            services.AddDatabaseDeveloperPageExceptionFilter();

            services.Configure<ExternalSettings>(Configuration.GetSection("ExternalSettings"));
